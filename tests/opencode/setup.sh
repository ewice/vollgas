...
mkdir -p "$HOME/.config/opencode/vollgas"
cp -r "$REPO_ROOT/lib" "$HOME/.config/opencode/vollgas/"
cp -r "$REPO_ROOT/skills" "$HOME/.config/opencode/vollgas/"

# Copy plugin directory
mkdir -p "$HOME/.config/opencode/vollgas/.opencode/plugins"
cp "$REPO_ROOT/.opencode/plugins/vollgas.js" "$HOME/.config/opencode/vollgas/.opencode/plugins/"

# Register plugin via symlink
mkdir -p "$HOME/.config/opencode/plugins"
ln -sf "$HOME/.config/opencode/vollgas/.opencode/plugins/vollgas.js" \
       "$HOME/.config/opencode/plugins/vollgas.js"
...
echo "Plugin installed to: $HOME/.config/opencode/vollgas/.opencode/plugins/vollgas.js"
echo "Plugin registered at: $HOME/.config/opencode/plugins/vollgas.js"
