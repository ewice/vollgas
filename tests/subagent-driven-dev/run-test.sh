...
#   ./run-test.sh svelte-todo --plugin-dir /path/to/vollgas
...
TIMESTAMP=$(date +%s)
OUTPUT_BASE="/tmp/vollgas-tests/$TIMESTAMP/subagent-driven-development"
...
PROMPT="Execute this plan using vollgas:subagent-driven-development. The plan is at: $PLAN_PATH"
