...
mkdir -p src test docs/vollgas/plans

# Create a simple implementation plan
cat > docs/vollgas/plans/implementation-plan.md <<'EOF'
...
I want you to execute the implementation plan at docs/vollgas/plans/implementation-plan.md using the subagent-driven-development skill.
...
# IMPORTANT: Run from vollgas directory so local dev skills are available
PROMPT="Change to directory $TEST_PROJECT and then execute the implementation plan at docs/vollgas/plans/implementation-plan.md using the subagent-driven-development skill.
...
if grep -q '"name":"Skill".*"skill":"vollgas:subagent-driven-development"' "$SESSION_FILE"; then
