...
[Read plan file once: docs/vollgas/plans/feature-plan.md]
...
You: "User level (~/.config/vollgas/hooks/)"
...
**Fallback:**
- **vollgas:executing-plans** - Use only when subagents are not available
